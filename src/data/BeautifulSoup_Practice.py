...
if '/Users/samlafell/Documents/Learning/sports_betting_project/src' not in sys.path:
    print('adding to path')
    sys.path.append('/Users/samlafell/Documents/Learning/sports_betting_project/src')
